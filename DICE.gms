...
If (ifopt eq 0,
       ...
       photel(t)=cprice.l(t);
       a2 = a20;
       cprice.fx(t)$(t.val<tnopol+1) = max(photel(t),cpricebase(t));
);
...
option decimals=4;
display tatm.l,cpc.l,scc,y.l,s.l;
display ri.l,miu.l,cca.l,photel,cpricebase,cprice.l,utility.l,t2xco2 ,a2,partfract;
...
put results;
put /"Results of DICE model run using model DICE2013R_103113_vanilla_v2b4.gms";
...
execute_unload "results.gdx", TATM.L,Y.L,DAMFRAC.L,CPC.L,cprice.L,MIU.L,scc,RI.l;
